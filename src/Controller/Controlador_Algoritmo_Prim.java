...
public class Controlador_Algoritmo_Prim extends MouseAdapter{
	
	private Marco marco;
	private CreadorDeGrafos cg;
	
//==============================================================================
		public Controlador_Algoritmo_Prim(Marco marco) {
			this.marco= marco;	
		}
//==============================================================================
	...
	obtenerCreadorDeGrafo();
	 ...
	 if(cg.getGrafo() ==null) {
		...
		GrafoPesado nuevo_grafo = AlgoritmoPrim.encontrarArbolGeneradorMinimo(cg.getGrafo());
		
		long tiempo = nuevo_grafo.getTiempo_Para_Prim_O_Kruskal(); 
		
		marco.getInfo().setText("==================ALGORITMO PRIM====================== " + "\n" 
